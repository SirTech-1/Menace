...
CC_FLAGS = -W -Wall -fno-rtti -ansi -Wshadow -Wextra -Wno-unused-function -m64 -std=c++17 -msse -flto=auto
LD_FLAGS = -Wl,--no-as-needed -Wno-unused-function -lpthread -m64 -std=c++17 -msse -flto=auto
